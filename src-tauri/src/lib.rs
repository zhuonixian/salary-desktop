...
pub fn run() {
    ...
    builder = builder.invoke_handler(tauri::generate_handler![
        ...
        commands::get_dashboard_reminders,
        commands::get_reminder_advance_days,
        commands::set_reminder_advance_days,
        ...
        commands::preview_bank_allocation_candidates,
        commands::preview_bank_auto_matches,
        commands::confirm_bank_allocations,
        commands::cancel_bank_allocation,
        ...
        // ===== Cashier（第七阶段 7B 资金单据与审批） =====
        commands::get_fund_documents,
        commands::get_fund_document_detail,
        commands::list_approval_events,
        commands::get_maker_checker_enabled,
        commands::set_maker_checker_enabled,
        commands::create_fund_document,
        commands::update_fund_document,
        commands::submit_fund_document,
        commands::approve_fund_document,
        commands::reject_fund_document,
        commands::withdraw_fund_document,
